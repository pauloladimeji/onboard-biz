...
function AuthInfoPanel() {
  return (
    <div className="auth-info-panel">
      ...
      <div className="auth-info-licenses">
...
function AuthShellSplit({ children, step, totalSteps }) {
  return (
...
// =====================================================
function AuthShell({ children, step, totalSteps, layout }) {
  if (layout === "split") {
    return <AuthShellSplit step={step} totalSteps={totalSteps}>{children}</AuthShellSplit>;
  }
...
// =====================================================
function SignUpScreen({ onSubmit, onSwitchToSignIn, layout }) {
  ...
  return (
    <AuthShell step={1} totalSteps={3} layout={layout}>
...
function RegisterBusinessScreen({ email, onSubmit, layout }) {
  ...
  return (
    <AuthShell step={2} totalSteps={3} layout={layout}>
...
function TotpSetupScreen({ onSubmit, onSkip, layout }) {
  ...
  return (
    <AuthShell step={3} totalSteps={3} layout={layout}>

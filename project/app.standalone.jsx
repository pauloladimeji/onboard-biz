...
function TopNav() {
  return (
    <header className="topnav">
      <div className="brand">
        <img src={window.__resources.logoLockup} alt="Onboard Business" />
      </div>
      <div style={{flex: 1}} />
      <div className="right">
...
// =====================================================
function MockPanel({ flow, onFlow, kyb, onKyb, accountsMode, onAccountsMode, payMode, onPayMode, route, nameLookupMock, onNameLookupMock, paymentApproval, onPaymentApproval, paymentApprovalMethod, onPaymentApprovalMethod, dataState, onDataState, accountStatus, onAccountStatus, complianceHold, onComplianceHold }) {
...
function App() {
  ...
  // Architecture toggle
  const [accountsMode, setAccountsMode] = useState("ref"); // "ref" | "named"
  ...
  if (route === "dashboard") {
    ...
    screen = accountsMode === "ref"
      ? <CurrencyDetailRefBased    code={openCcy} onBack={backToAccounts} onToast={showToast} kybApproved={kyb === "approved"} />
